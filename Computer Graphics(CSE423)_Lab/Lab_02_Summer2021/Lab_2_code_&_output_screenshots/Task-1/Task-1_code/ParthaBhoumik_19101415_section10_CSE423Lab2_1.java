...
class ThirdGLEventListenerrrrr implements GLEventListener {
/**
...
// these three mid calls will draw 1
mid (gl, -10, -50, -10, 80) ; // draws " | "
mid (gl, -45, -50, 20, -50) ; // draws " _ "
mid (gl, -10, 80, -50, 50) ; // draws " / "

// these 7 mid calls will draw 5
mid (gl, 150, 80, 150, 60) ; // draws " | "
mid (gl, 45, 80, 150, 80) ; // draws " - "
mid (gl, 45, 20, 45, 80) ; // draws " | "
mid (gl, 45, 20, 150, 20) ; // draws " - "
mid (gl, 150, 20, 150, -40) ; // draws " | "
mid (gl, 135, -50, 48, -50) ; // draws " _ "
mid (gl, 135, -50, 150, -40) ; // draws " _ "
...
public class ParthaBhoumik_19101415_section10_CSE423Lab2_1 {
...
ThirdGLEventListenerrrrr b=new ThirdGLEventListenerrrrr();
glcanvas.addGLEventListener(b);
glcanvas.setSize(640, 400);
//creating frame

final JFrame frame=new JFrame("19101415_Task-1_Frame");
